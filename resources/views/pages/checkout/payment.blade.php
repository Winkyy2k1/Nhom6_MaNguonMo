...
@section('content')
    ...
    <section id="cart_items">
		<div style="width:1050px;" class="container">
            ...
            <h3 style="margin-bottom: 40px; color: #cc8de0;">Chọn Hình Thức Thanh Toán:</h3>
            <form action="{{URL::to('/order-place')}}" method="POST">
			    ...
			    <div class="payment-options">
                    ...
                    <br>
                    <input style="margin-top: 15px; background-color: #cc8de0; border: none; width: 100px; height:30px; color: white;" type="submit" value="Đặt Hàng" name="send_order_place" class="btl btl-primary btl-sm">
				</div>
            </form>
		</div>
	</section>
